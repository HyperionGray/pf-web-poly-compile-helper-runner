...
- `demos/screenshot_tui.py` - Demo script for screenshots (tested in tests/test_screenshot_tui.py)
- `demos/demo_tui.py` - Non-interactive TUI demonstration (tested in tests/test_demo_tui.py)
