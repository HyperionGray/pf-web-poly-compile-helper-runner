...
- `pf-runner/pf_grammar.py` (3558 lines) - **Auto-generated by Lark v1.3.0**
...
- ✅ **README.md** (8095 words) - Comprehensive project overview
- ✅ **QUICKSTART.md** (3358 words) - Getting started guide
- ✅ **CONTRIBUTING.md** (741 words) - Contribution guidelines
- ✅ **LICENSE.md** (169 words) - License information
- ✅ **CHANGELOG.md** (1214 words) - Version history
- ✅ **CODE_OF_CONDUCT.md** (770 words) - Community guidelines
- ✅ **SECURITY.md** (959 words) - Security policies

**Total Root Documentation:** 15,306 words (sum of above files)
