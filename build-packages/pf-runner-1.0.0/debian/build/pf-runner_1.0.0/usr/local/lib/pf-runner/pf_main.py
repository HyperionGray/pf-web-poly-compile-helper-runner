        ...
        try:
            ...
            if not tasks_with_desc:
                ...
                if args.file:
                    ...
                    print("Create pf-files/Pfyfile.pf (recommended) or Pfyfile.pf, or specify one with: pf -f <path> list")
                return 0
            ...
            print("  - Create pf-files/Pfyfile.pf (recommended) or Pfyfile.pf in your project directory", file=sys.stderr)
