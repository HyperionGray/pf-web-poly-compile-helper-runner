...
### Task Files in `pf-files/`
1. `pf-files/always-available/Pfyfile.always-available.pf`
2. `pf-files/always-available/Pfyfile.always-on.pf`
3. `pf-files/always-available/Pfyfile.tui.pf`

### Documentation
- `docs/ALWAYS-ON-TASKS.md` - Comprehensive 300+ line guide

### Modified Files
- `pf-files/Pfyfile.pf` - Includes always-available TUI tasks (and other categories)
