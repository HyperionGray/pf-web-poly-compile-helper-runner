...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -q "web-build"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -q "api-server\|web-dev"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "debug"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -q "tui"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -q "security"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "git-cleanup\|git-analyze"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "inject\|injection"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "lift\|retdec"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "rop"; then
...
cd "$REPO_ROOT"
if $PF_CMD pf-files/Pfyfile.pf list 2>&1 | grep -qi "kernel"; then
