...
The `pf-files/auto-api/Pfyfile.rest-api.pf` demonstrates alias usage:
...
- [pf-files/auto-api/Pfyfile.rest-api.pf](../pf-files/auto-api/Pfyfile.rest-api.pf) - Example alias definitions
