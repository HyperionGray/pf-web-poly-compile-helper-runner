...
- **Tasks:** 5 tasks matching `task.*install`

### Issue #2: Always-On Installation Files
- **Priority:** 🔴 High
- **Labels:** testing, high-priority
- **Files:** pf-files/always-available/Pfyfile.always-on.pf (1 file)
- **Tasks:** 26 tasks (1 install-related)

### Issue #3: Tool Installation Files
- **Priority:** 🟡 Medium
- **Labels:** testing, medium-priority
- **Files:** pf-files/debugging/Pfyfile.debug-tools.pf, pf-files/exploit-writing/Pfyfile.exploit.pf, etc. (4 files)
- **Tasks:** 19 tasks matching `task.*install`

### Issue #4: Package Manager and Container Files
- **Priority:** 🟡 Medium
- **Labels:** testing, medium-priority
- **Files:** pf-files/distro-switching/Pfyfile.package-manager.pf, pf-files/containers/Pfyfile.containers.pf, etc. (3 files)
- **Tasks:** 7 tasks matching `task.*install`

### Issue #5: Security and TUI Files
- **Priority:** 🟡 Medium
- **Labels:** testing, medium-priority
- **Files:** pf-files/vuln-hunting/Pfyfile.security.pf, pf-files/always-available/Pfyfile.tui.pf, etc. (5 files)
- **Tasks:** 6 tasks matching `task.*install`
