...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_trigger_trap')) {
        Object.defineProperty(Module['ready'], '_trigger_trap', { configurable: true, get: function() { abort('You are getting _trigger_trap on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_trigger_trap', { configurable: true, set: function() { abort('You are setting _trigger_trap on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
var wasmBinaryFile;
if (Module['locateFile']) {
  wasmBinaryFile = 'c_trap.wasm';
  if (!isDataURI(wasmBinaryFile)) {
    wasmBinaryFile = locateFile(wasmBinaryFile);
  }
} else {
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  wasmBinaryFile = new URL('c_trap.wasm', import.meta.url).toString();
}
...
/** @type {function(...*):?} */
var _trigger_trap = Module["_trigger_trap"] = createExportWrapper("trigger_trap");
